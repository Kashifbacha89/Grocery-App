  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: TextWidget(text: 'All product',color: color,textSize: 24,isTitle: true,),
        centerTitle: true,
      ),
        ...
        child: Column(
          children: [
           ...
           _searchController.text.isNotEmpty && listProductSearch.isEmpty?
                const EmptyProductWidget(text: 'product can not be found ,please try another keyword'):
